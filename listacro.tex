...
\newabbreviation{rms}{rms}{réponses moyennes standardisées}
\newabbreviation{nose}{nose}{Nasal Obstruction Symptom Evaluation}
% \newabbreviation{}{}{}
...
\newglossaryentry{pca}{name={\textsc{pca}}, description={Analyse en composante principales. Corrélations multiples entre des variables numériques. Une variable peut être ajoutée qui sera représentée sur les graphiques mais ne participe pas aux calculs.}}
