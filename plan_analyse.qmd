...
[https://github.com/philippemichel/\\gls{faceq}](https://github.com/philippemichel/\gls%7Bfaceq%7D){.uri}
...
*Validation psychométrique du questionnaire* \gls{faceq} adapté à la reconstruction (Questionnaire Nasal Reconstruction \gls{faceq})
...
La cohérence interne du test sera étudiée dans le groupe `patients` à l’aide du coefficient $\alpha$ de Cronbach (package `psych` [@psych]). Un $\alpha$ supérieur à \num{0.7} sera considéré comme satisfaisant.
...
Les corrélations entre les trois échelles du score \gls{faceq} & les les deux scores composites du SF36 (mental & physique) seront calculées (test de Pearson ou de Spearman selon la distribution des scores).

# Objectifs secondaires

## Évaluation de la satisfaction fonctionnelle

*Évaluation de la satisfaction fonctionnelle post-opératoire obtenues grâce au questionnaire* \gls{nose} qui permet de mesurer l’importance de la gêne respiratoire nasale. Ce questionnaire est rempli uniquement par les patients, non par les témoins. 
